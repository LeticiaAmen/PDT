...
public class VentanaAnalista_Reportes extends JPanel {
	...
	public VentanaAnalista_Reportes(UsuariosBeanRemote usuariosBean, Usuario usuario) {		
			...
			public void actionPerformed(ActionEvent e) {		
		            ...
		            try {
						...
						if(estudiante == null) {
							...
							JOptionPane.showMessageDialog(null, "Escolaridad no disponible.");	
		...
		// -------------------------------------VOLVER--------------------------------------//
				...
				btnVolver.addMouseListener(new MouseAdapter() {
					...
					public void mouseClicked(MouseEvent e) {
						VentanaAnalista_ListadoDeUsuarios volver = new VentanaAnalista_ListadoDeUsuarios(usuariosBean, usuario);
