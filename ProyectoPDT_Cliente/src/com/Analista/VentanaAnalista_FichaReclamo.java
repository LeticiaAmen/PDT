...
public class VentanaAnalista_FichaReclamo extends JPanel {
	...
	public VentanaAnalista_FichaReclamo(UsuariosBeanRemote usuariosBean, Reclamo reclamo, Usuario usuario) {
		...
		try {
			...
			lblNombreEstudiante.setBounds(62, 60, 64, 13);
			panelForm.add(lblNombreEstudiante);
			JLabel lblNombreEstudianteGet = new JLabel("--");
			lblNombreEstudianteGet.setBounds(111, 60, 153, 13);
			...
			lblAsuntoGet.setBounds(62, 30, 205, 13);
			...
			btnModificar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					int dialogResult = JOptionPane.showOptionDialog(null, "¿Desea modificar el estado del reclamo?","Advertencia",
						...
						for(EstaReclamo eR: estaReclamos) {
							...
							if (dialogResult == JOptionPane.YES_OPTION) {	//**
								...
								List<EstaReclamo> estaReclamos1 = estaReclamoBean.obtenerEstaRecTodos(); 
								for(EstaReclamo eR1: estaReclamos1) {
									if(eR1.getReclamo().getIdReclamo() == reclamo.getIdReclamo()) {
										comboEstado.setSelectedItem(eR1.getEstado().getNombre()); 
									}
								}
							}
						}//**				
