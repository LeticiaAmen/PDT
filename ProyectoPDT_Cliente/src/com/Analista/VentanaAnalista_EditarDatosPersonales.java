...
public class VentanaAnalista_EditarDatosPersonales extends JPanel {
	...
	public VentanaAnalista_EditarDatosPersonales(Usuario usuario) {
...
//--------------------------TIPO DE USUARIO---------------------------------//
			...
			comboBoxTipoDeUsuario.setModel(new DefaultComboBoxModel<>(new String[] {"Analista"}));
			comboBoxTipoDeUsuario.setEnabled(false);
			comboBoxTipoDeUsuario.setBounds(497, 66, 125, 20);
			panelForm.add(comboBoxTipoDeUsuario);

			JLabel lblTipoDeUsuario = new JLabel("Tipo de Usuario");
			lblTipoDeUsuario.setBounds(497, 42, 158, 13);
			panelForm.add(lblTipoDeUsuario);
			comboBoxTipoDeUsuario.setSelectedItem("Analista");
					...
					if (valido) {
						...
						if (respuesta == JOptionPane.YES_OPTION) {
							...
							try {
								...
								JOptionPane.showMessageDialog(null, "Usuario modificado"); // Mensaje
