		...
		btnEditarReclamo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!campoFaltante.isEmpty()) {
					...
					int opcion = JOptionPane.showOptionDialog(null, "¿Deseas realizar la modificación?",
							"Confirmación", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, opciones, opciones[0]);
