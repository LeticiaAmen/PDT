...
public class VentanaEstudiante_Reportes extends JPanel {
	...
	public VentanaEstudiante_Reportes(UsuariosBeanRemote usuariosBean, Usuario usuario) {
				...
				if (option == JFileChooser.APPROVE_OPTION) {
					...
					try {
						...
						PdfWriter.getInstance(document, new FileOutputStream(
								path + "/Escolaridad " + usuario.getNombres() + " " + usuario.getApellidos() + ".pdf"));
						document.open();
		...
		btnVerEscolaridad.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					sb.append("Nombre: ").append(usuario.getNombres()).append(" ").append(usuario.getApellidos())
							.append("\n");
		...
		btnVolver.setBounds(588, 417, 119, 23);
	...
	public void mostrarVentanaReporteEstudiante() {
