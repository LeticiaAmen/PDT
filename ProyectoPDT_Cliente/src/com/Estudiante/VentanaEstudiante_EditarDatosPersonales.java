...
public class VentanaEstudiante_EditarDatosPersonales extends JPanel {
	...
	private EstudianteBeanRemote estudanteBean;
	...
	public VentanaEstudiante_EditarDatosPersonales(Usuario usuario, Estudiante estudiante) {
		...
		try {
			...
			lblFormularioDeRegistro.setBounds(258, 0, 226, 20);
			panelForm.add(lblFormularioDeRegistro);

			// --------------------------TIPO DE USUARIO---------------------------------/
			JComboBox<String> comboBoxTipoDeUsuario = new JComboBox<String>();
			comboBoxTipoDeUsuario.setModel(new DefaultComboBoxModel<>(new String[] {"Estudiante"}));
			...
			comboBoxTipoDeUsuario.setSelectedItem("Estudiante");
...
// -------------------------CORREO INSTITUCIONAL PARA MODIFICAR-------------------------------//
...
// -------------------------GENERO PARA MODIFICAR-------------------------------//
			...
			comboBoxSemestre.setBounds(517, 190, 125, 21);
			panelForm.add(comboBoxSemestre);
			Semestre semestre = estudiante.getSemestre();
		   ...
		   // -------------------------ESTUDIANTE GENERACION-------------------------------//
			...
			comboBoxGeneracion.setBounds(517, 128, 125, 21);
			...
			btnEnviar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if (valido) {
						...
						int respuesta = JOptionPane.showOptionDialog(null, "¿Deseas modificar?", "Confirmar modificación",
						...
						if (respuesta == JOptionPane.YES_OPTION) {
							...
							try {
								...
								try {
									...
									JOptionPane.showMessageDialog(null, "Estudiante modificado"); // Mensaje
			...
			btnCancelar.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent e) {
					...
					int respuesta = JOptionPane.showOptionDialog(null,
							"¿Deseas cancelar la modificación?", "Confirmar cancelación",
							JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, opciones, opciones[0]);
					if (respuesta == JOptionPane.YES_OPTION) {
						...
						cambiarContenido(panelForm, estudiante);
