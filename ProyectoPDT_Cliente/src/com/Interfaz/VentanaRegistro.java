...
//--------------------------------CAMPOS DE REGISTRO-----------------------------------------//
		...
		passwordFieldContrasenia.setToolTipText("Mínimo 8 caracteres y al menos un número");
		...
		textFieldCorreoI.setToolTipText("Estudiantes: nombre.apellido@estudiantes.utec.edu.uy -- Tutor/Analista: nombre.apellido@utec.edu.uy");
		...
		textFieldDocumento.setToolTipText("Sin puntos ni guiones");
			...
			public void actionPerformed(ActionEvent e) {
				...
				while (!valido) {
					if (textFieldNombres.getText().isEmpty()) {
						...
						break;
					} else if (comboBoxDepartamento.getSelectedItem() == null || comboBoxDepartamento.getSelectedItem() == " ") {
						JOptionPane.showMessageDialog(null, "Debe seleccionar un Departamento");
						break;
					} else if (comboBoxLocalidad.getSelectedItem() == null || comboBoxLocalidad.getSelectedItem() == " ") {
						JOptionPane.showMessageDialog(null, "Debe seleccionar una Localidad");
						break;
					} else if (comboBoxItr.getSelectedItem() == null || comboBoxItr.getSelectedItem() == " ") {
				...
				if (valido) {
					...
					int respuesta = JOptionPane.showOptionDialog(null, "¿Desea enviar el registro?", "Confirmar enviar",
					...
					if (respuesta == JOptionPane.YES_OPTION) {
				        ...
				        SwingUtilities.getWindowAncestor(btnEnviar).dispose();
		...
		btnCancelar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Object[] opciones = { "Sí", "No" };
				int respuesta = JOptionPane.showOptionDialog(null, "¿Desea cancelar el registro?",
