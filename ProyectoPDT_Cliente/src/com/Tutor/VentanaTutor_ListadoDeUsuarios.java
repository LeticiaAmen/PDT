...
public class VentanaTutor_ListadoDeUsuarios extends JPanel {
	...
	public VentanaTutor_ListadoDeUsuarios(UsuariosBeanRemote usuariosBean, Usuario usuario) {
...
// -------------------------------------USUSARIO SELECCIONADO DE LA TABLA--------------------------------------//
		...
		btnReportes.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				VentanaTutor_Reportes reportes = new VentanaTutor_Reportes(usuariosBean, p1);
...
// -------------------------------------VOLVER--------------------------------------//
		...
		btnVolver.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				VentanaTutor volver = new VentanaTutor(usuariosBean, VentanaTutor.getUsuario());
