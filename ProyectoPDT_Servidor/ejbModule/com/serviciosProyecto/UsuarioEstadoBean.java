...
public class UsuarioEstadoBean implements UsuarioEstadoBeanRemote {
	...
	public List<UsuarioEstado> obtenerUEstadoTodos() {
		TypedQuery<UsuarioEstado> query = entityManager.createQuery("SELECT u FROM UsuarioEstado u",
				UsuarioEstado.class);
	...
	public UsuarioEstado obtenerEstadoPorNombre(String nombre) {
		TypedQuery<UsuarioEstado> query = entityManager.createNamedQuery("UsuarioEstado.obtenerPorNombre",
				UsuarioEstado.class);
